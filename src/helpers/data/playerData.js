...
const updatePlayer = (playerId, newPlayerObj) => axios.put(`${baseUrl}/players/${playerId}.json`, newPlayerObj);

export default { addPlayer, deletePlayer, getPlayersByUid, updatePlayer };
